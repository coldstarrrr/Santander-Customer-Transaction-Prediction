...
if __name__ == "__main__":
    ...
    blending_submission_1.to_csv(os.path.join(path, "blending_submission_1.csv"))
    ...
    blending_submission_2.to_csv(os.path.join(path, "blending_submission_2.csv"))
    ...
    blending_submission_3.to_csv(os.path.join(path, "blending_submission_3.csv"))